...
@ut.skipUnless(h5py.version.hdf5_version_tuple < (1, 9, 300), 'SWMR is available. Skipping backwards compatible tests')
...
@ut.skipUnless(h5py.version.hdf5_version_tuple >= (1, 9, 300), 'SWMR requires HDF5 >= 1.9.300')
